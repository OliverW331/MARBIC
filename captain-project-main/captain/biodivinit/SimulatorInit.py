...
def init_simulated_system(
    ...
    for species_id in rnd_species_order:
        #max_n_ind is the maximum number of individuals for this species
        ...
        #n_indviduals_per_cell_1D = total number of individuals in each cell
        #updated to include the new individuals added in this iteration
        #n_indviduals_per_cell_sp_i = the distribution of individuals of each species added to each cell
        #update the species_hist of each cell in list_cells
        ...
        j += 1
    #save the updated list of cell objects
